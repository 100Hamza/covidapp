...
/// active : 11521
/// critical : 0
/// casesPerOneMillion : 5544
/// deathsPerOneMillion : 195
/// tests : 1306612
/// testsPerOneMillion : 32061
/// population : 40754388
/// continent : "Asia"
/// oneCasePerPeople : 180
/// oneDeathPerPeople : 5128
/// oneTestPerPeople : 31
/// activePerOneMillion : 282.69
/// recoveredPerOneMillion : 5066.62
/// criticalPerOneMillion : 0

class CountiresListModel {
  CountiresListModel({
      int? updated, 
      String? country, 
  ...
  CountiresListModel.fromJson(dynamic json) {
...
CountiresListModel copyWith({  int? updated,
  String? country,
  CountryInfo? countryInfo,
  int? cases,
  int? todayCases,
  ...
  double? recoveredPerOneMillion,
  int? criticalPerOneMillion,
}) => CountiresListModel(  updated: updated ?? _updated,
